<template>
  <div class="doors">
    <app-nav></app-nav>
    <table class="center">
      <tr v-for="item in doors" v-bind:key="item">
        <td>
          <input type="radio" :id="item" v-bind:value="item" v-model="door">
        </td>
        <td>
          <label >{{ item }}</label>
        </td>
    ...
    <div style="position:relative">
      ...
      <div v-if="resp != ''">
        ...
        <table class="center">
          ...
          <tr v-for="(item, index) in this.resp.states.state" v-bind:key="item">
            <td>
        ...
        <table class="center">
          ...
          <tr v-for="(item, index) in this.resp.actions.action" v-bind:key="item">
            <td>
